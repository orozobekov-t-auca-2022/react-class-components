...
describe('Card Component', () => {
  ...
  const pokemonImageUrl = 'https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/4.png';
  const pokemonSpeciesUrl = 'https://pokeapi.co/api/v2/pokemon-species/charmander'
  ...
  it('displays the fetched image and description for a pokemon', async () => {
    ...
    expect(screen.getByText(/Obviously prefers hot places. When it rains, steam is said to spout from the tip of its tail./i)).toBeInTheDocument();
